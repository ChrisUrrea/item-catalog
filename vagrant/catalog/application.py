...
def newValuable(pawnshop_id):
    ...
    if login_session['user_id'] != pawnshop.user_id:
        return "<script>function myFunction() {" \
               "alert('You are not authorized to add valuables to this pawn shop. " \
...
def editValuable(pawnshop_id, valuable_id):
    ...
    if login_session['user_id'] != pawnshop.user_id:
        return "<script>function myFunction() {alert" \
               "('You are not authorized to edit menu items to this pawnshop. " \
               "Please create your own pawnshop in order to edit items.');}" \
               "</script><body onload='myFunction()''>"
    if request.method == 'POST':
...
def deletePawnShop(pawnshop_id):
    ...
    if pawnshopToDelete.user_id != login_session['user_id']:
        return "<script>function myFunction() {" \
               "alert('You are not authorized to delete this pawnshop. " \
